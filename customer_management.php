                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-material floating">
                                            <input class="form-control" type="text" name="customer_search" id="customer_search" style="text-align: right;">
                                            <label for="number_input">Customer Search</label>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <form method="POST" action='./functions/submit_customer_details.php'>
                                        
                                    
                                    <div class="form-material floating" style="margin-bottom: 25px;">
                                        <input class="form-control" type="text" name="customer_id" id="customer_id" style="text-align: right;" value="<?php echo $cus_id; ?>" readonly>
                                        <label for="number_input">Customer ID</label>
                                    </div>

                                    <div class="form-material floating" style="margin-bottom: 25px;">
                                        <input class="form-control" type="text" name="customer_f_name" id="customer_f_name" style="text-align: right;" value="<?php echo $customer_fname; ?>">
                                        <label for="number_input">Customer First Name</label>
                                    </div>

                                    <div class="form-material floating" style="margin-bottom: 25px;">
                                        <input class="form-control" type="text" name="customer_m_name" id="customer_m_name" style="text-align: right;" value="<?php echo $customer_mname; ?>">
                                        <label for="number_input">Customer Middle Initial</label>
                                    </div>

                                    <div class="form-material floating" style="margin-bottom: 25px;">
                                        <input class="form-control" type="text" name="customer_l_name" id="customer_l_name" style="text-align: right;" value="<?php echo $customer_lname; ?>">
                                        <label for="number_input">Customer Last Name</label>
                                    </div>

                                    <div class="form-material floating" style="margin-bottom: 25px;">
                                        <input class="js-masked-phone-ext form-control" type="text" name="customer_contact_num" id="customer_contact_num" style="text-align: right;" placeholder="(999) 999-9999? x99999" value="<?php echo $customer_contact_number; ?>">
                                        <label for="number_input">Customer Contact Number</label>
                                    </div>

                                    <div class="form-material floating" style="margin-bottom: 25px;">
                                        <input class="form-control" type="text" name="customer_address" id="customer_address" style="text-align: right;" value="<?php echo $customer_address; ?>">
                                        <label for="number_input">Customer Address</label>
                                    </div>

                                    <div class="form-material floating" style="margin-bottom: 25px;">
                                       <input type="submit" name="submit_customer_btn" class="btn btn-success" style="margin-left: 20%;"> 
                                       <input type="button" class="btn btn-danger" style="margin-left: 1%;" id="clear_customer_btn" value="Clear Form">
                                    </div>
...
//--------------------------------------------------------------------------------------
                ...
                // $('#submit_customer_btn').on('click', function() {
                //     var customer_id = $("#customer_id").val();
                //     var customer_first_name = $("#customer_f_name").val();
                //     var customer_middle_name = $("#customer_m_name").val();
                //     var customer_last_name = $("#customer_l_name").val();
                //     var customer_contact_number = $("#customer_contact_num").val();
                //     var customer_address = $("#customer_address").val();

                //     $.ajax({
                //             url: "functions/submit_customer_details.php",
                //             type: "POST",
                //             data: {
                ...
                $("#modal-customer_modal").on("shown.bs.modal",function(){
                    $("#customer_first_name").focus();
                });


                $('#clear_customer_btn').on('click', function(){
                    $('#customer_id').val('');
                    $('#customer_f_name').val('');
                    $('#customer_m_name').val('');
                    $('#customer_l_name').val('');
                    $('#customer_contact_num').val('');
                    $('#customer_address').val('');
                    window.location.href = 'customer_management.php';
                });
               

                    $.ajax({    //checking of session
                        type: "GET",
                        url: "./functions/customer_session_checker.php",             
