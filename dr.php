                ...
                <main class="app-layout-content">
                    ...
                    <div class="container-fluid p-y-md">
                        ...
                        <div class="row">
                            ...
                            <button data-toggle="modal" data-target="#modal-select_cust">Open modal</button>

                            <div class="modal fade" id="modal-select_cust" tabindex="-1" role="dialog" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-popout">
                            <div class="modal-content">
                                ...
                                <table class="table table-borded table-striped table-vcenter js-dataTable-full" id='asd'>
                                    <thead>
                                        <tr>
                                            <td>ID</td>
                                            <td>Company</td>
