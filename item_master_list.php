...
if(isset($_SESSION['item_submitted'])){
    $submitted = $_SESSION['item_submitted'];
}else{
    $submitted = '';
}
if(isset($_GET['edit_id'])){
    ...
    include('./functions/item_id_checker.php');
    $item_name = $_SESSION['item_name'];
    $item_price = $_SESSION['price'];
    $item_class = $_SESSION['item_class'];
}
else{
    $item_id = '';
    $item_name = '';
    ...
    <body class="app-ui layout-has-drawer layout-has-fixed-header">
                        ...
                        <div class="row">
                           <!--  <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" id="item_search" name="item_search" placeholder="Search" />
                        ...
                        <div class="row">
                            <div class="col-sm-8">
                                ...
                                <div id="item_master_list_table">
                                    ...
                                    <tbody>
                                        <?php include("./functions/retrieve_item_master_list_table.php") ?>
                                    </tbody>
                                    </table>
                            ...
                            <div class="col-sm-4">
                                <form method="POST" action="./functions/submit_item_master_list.php">
                                    <h2 style="font-family: 'Copperplate', fantasy;margin-left: 28% ;"><i class="fa fa-shopping-cart"></i> Item Form</h2>
                                    <div class="form-material floating" style="margin-bottom: 25px;margin-top: 25px;">
                                        <input class="form-control" type="text" name="item_id" id="item_id" placeholder=" KEEP THIS BLANK TO INPUT NEW!!!" style="text-align: right;" value="<?php echo $item_id; ?>" readonly>
                                        <label for="number_input">Item ID</label>
                                    </div>

                                    <div class="form-material floating" style="margin-bottom: 25px;">
                                        <input class="form-control" type="text" name="item_name" id="item_name" style="text-align: right;" value="<?php echo $item_name; ?>">
                                        <label for="number_input">Item Name</label>
                                    </div>

                                    <div class="form-material floating" style="margin-bottom: 25px;">
                                        <input class="form-control" type="text" name="item_price" id="item_price" style="text-align: right;" value="<?php echo $item_price; ?>">
                                        <label for="number_input">Item Price</label>
                                    </div>

                                    <div class="form-material floating" style="margin-bottom: 25px;">
                                        <select class="form-control" style="text-align: right;" id="item_class" name="item_class">
                                            <option></option>
                                            <?php
                                            include('./functions/retrieve_item_class_option.php');
                                            ?>
                                        </select>
                                    ...
                                    <a href="./functions/item_master_list_unset.php"><input type="button" class="btn btn-danger" style="margin-left: 1%;" value="Clear Form" name="clear_item_form" id="clear_item_form" /></a>
        ...
        <script>
            ...
            if(submitted != ''){
                ...
                <?php unset($_SESSION['item_submitted']); ?>  
                $("#item_name").focus();
            }



            $("#clear_item_form").on("click", function () {
                $('#item_class option').prop('selected', function() {
                ...
                var delete_id = "<?php echo $_SESSION['delete_id']; ?>";
                if(delete_id != ""){
                        Swal.fire({
                          title: 'Are you sure?',
                          ...
                          if (result.isConfirmed) {
                            ...
                            $.ajax({
                                    url: "functions/delete_item_master_list.php",
                                    type: "POST",
                                    data: {
                                       delete_id: delete_id
                                    },
                                    success: function(dataResult){
                                        ...
                                        Swal.fire({
                                          position: 'center',
                                          icon: 'success',
                                          title: 'Deleted Item Details.',
                                          showConfirmButton: false,
                                          timer: 1500
                                        })
                                        setTimeout(function() {
                                           window.location.href = "item_master_list.php";
                                          }, 1500);
                                    }
                            });
                            ...
                            window.location.replace("item_master_list.php");
                          }
                        })
                }
                ...
                $("#item_name").focus();
                 // $("#item_price").inputmask({"mask": "(999) 999-9999"});
